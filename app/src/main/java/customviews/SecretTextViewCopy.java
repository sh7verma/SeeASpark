...
public class SecretTextViewCopy extends TextView {
    ...
    private SecretTextView.ValueUpdateListener valueUpdateListener;

    public interface ValueUpdateListener {
        void onAnimationComplete(boolean isVisible);
    }
    ...
    ValueAnimator.AnimatorUpdateListener listener = new ValueAnimator.AnimatorUpdateListener() {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            if (percent == 2.0f)
                valueUpdateListener.onAnimationComplete(mIsVisible);
        }
    };

    public SecretTextViewCopy(Context context) {
        super(context);
        init();
    }

    public void setValueUpdateListener(SecretTextView.ValueUpdateListener valueUpdateListener) {
        this.valueUpdateListener = valueUpdateListener;
    }

    public SecretTextViewCopy(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
