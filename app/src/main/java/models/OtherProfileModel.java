...
public class OtherProfileModel extends BaseModel {
    /**
    ...
    private CardsDisplayModel response;
    private int code;

    public CardsDisplayModel getResponse() {
        return response;
    }

    public void setResponse(CardsDisplayModel response) {
