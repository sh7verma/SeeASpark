...
//                            if (!mMessage.attachment_status.equals(Constants.FILE_EREROR) && !mMessage.attachment_status.equals(Constants.FILE_UPLOADING)) {
                                if (mMessage.message_status >= Constants.STATUS_MESSAGE_SENT) {
                                    mConversationActivity.isOptionsVisible();
                                    mConversationActivity.makeOptionsVisible(position, mMessage.message_id, 2);
                                    notifyDataSetChanged();
                                }
                                return true;
                            }
                        ...
                        mSentImageHolder.imgImageSent.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
//                            if (!mMessage.attachment_status.equals(Constants.FILE_EREROR) && !mMessage.attachment_status.equals(Constants.FILE_UPLOADING)) {
                                if (mMessage.message_status >= Constants.STATUS_MESSAGE_SENT) {
...
//                        mConversationActivity.openFullViewActivity();
                        ...
                        mReceiveImageHolder.imgImageReceive.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                if (/*!mMessage.attachment_status.equals(Constants.FILE_EREROR) &&*/ !mMessage.attachment_status.equals(Constants.FILE_UPLOADING)) {
                                    mConversationActivity.isOptionsVisible();
...
//                            if (!mMessage.attachment_status.equals(Constants.FILE_EREROR) && !mMessage.attachment_status.equals(Constants.FILE_UPLOADING)) {
                        ...
                        mSentVideoHolder.imgVideoSent.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
//                            if (!mMessage.attachment_status.equals(Constants.FILE_EREROR) && !mMessage.attachment_status.equals(Constants.FILE_UPLOADING)) {
                                if (mMessage.message_status >= Constants.STATUS_MESSAGE_SENT) {
                        ...
                        mReceiveVideoHolder.imgVideoReceive.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                if (/*!mMessage.attachment_status.equals(Constants.FILE_EREROR) &&*/ !mMessage.attachment_status.equals(Constants.FILE_UPLOADING)) {
                                    mConversationActivity.isOptionsVisible();
